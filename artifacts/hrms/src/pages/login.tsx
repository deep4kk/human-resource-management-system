      ...
      >
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12 glass bg-white/80 dark:bg-card/80">
          <div className="flex items-center gap-3 mb-10">
            ...
            <span className="font-display font-bold text-2xl tracking-tight">Toyo Kambocha</span>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-border">
            <p className="text-sm text-muted-foreground mb-4 text-center">Demo Accounts (Click to fill)</p>
            <div className="grid grid-cols-3 gap-2">
              <button onClick={() => setDemo("admin@toyokambocha.com", "admin123")} className="py-2 px-2 rounded-lg bg-secondary hover:bg-secondary/80 text-xs font-medium border border-border/50 transition-colors">Admin</button>
              <button onClick={() => setDemo("hr@toyokambocha.com", "hr123")} className="py-2 px-2 rounded-lg bg-secondary hover:bg-secondary/80 text-xs font-medium border border-border/50 transition-colors">HR Mgr</button>
              <button onClick={() => setDemo("emp@toyokambocha.com", "emp123")} className="py-2 px-2 rounded-lg bg-secondary hover:bg-secondary/80 text-xs font-medium border border-border/50 transition-colors">Employee</button>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:flex w-1/2 relative bg-primary items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 p-12 text-center text-primary-foreground">
            ...
            <p className="text-lg text-primary-foreground/80 leading-relaxed max-w-md mx-auto">
              A comprehensive HR management suite designed to streamline your operations, nurture talent, and build a thriving company culture.
            </p>
          </div>
        </div>
      </motion.div>
